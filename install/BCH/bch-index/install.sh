...
# environment
serviceName="bch-index"
version="8.25.17"
installPath="/data/BCH/${serviceName}-${version}"
downloadUrl="https://github.com/bitpay/bitcore/archive/refs/tags/v${version}.tar.gz"
nodeIp="127.0.0.1" # 安装 bch-node 主机 ip
[ "$chainId" = "mainnet" ] && rpcPort="8332" || rpcPort="18332"  # 同 bch-node 配置
[ "$chainId" = "mainnet" ] && p2pPort="8333" || p2pPort="18333"  # 同 bch-node 配置
rpcUser="username"    # 同 bitcoin 配置
rpcPassword="password"   # 同 bitcoin 配置
