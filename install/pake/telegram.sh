...
# 2026/02/24
# install pake
# curl -SsL https://gitee.com/Xiechengqi/scripts/raw/master/install/pake/telegram.sh | sudo bash
#
...
export serviceName="pake-telegram"
export serviceUrl="https://web.telegram.org"
export serviceTaskbar="Telegram"
