...
# 2026/02/24
# install pake
# curl -SsL https://gitee.com/Xiechengqi/scripts/raw/master/install/pake/x.sh | sudo bash
#
...
export serviceName="pake-x"
export serviceUrl="https://x.com"
export serviceTaskbar="X"
