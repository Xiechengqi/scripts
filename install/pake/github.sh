...
# 2026/02/24
# install pake
# curl -SsL https://gitee.com/Xiechengqi/scripts/raw/master/install/pake/github.sh | sudo bash
#
...
export serviceName="pake-github"
export serviceUrl="https://github.com"
export serviceTaskbar="Github"
