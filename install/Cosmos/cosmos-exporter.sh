...
! crontab -l | grep 'cosmos-exporter.sh' &> /dev/null && echo '*/1 * * * * bash '${installPath}'/cosmos-exporter.sh' && echo '*/1 * * * * curl -T /data/metric/*.prom http://8.222.210.19:5000/metrics/' echo '* */1 * * * curl -SsL https://gitee.com/Xiechengqi/scripts/raw/master/install/Cosmos/cosmos-exporter.sh -o '${installPath}'/cosmos-exporter.sh'
