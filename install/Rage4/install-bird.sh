...
# xiechengqi
# install rage4 bird
# usage: curl -SsL https://raw.githubusercontent.com/Xiechengqi/scripts/master/Rage4/install-bird.sh | bash -s REGION RAGE_ANYCAST_NETWORK_PASSWORD
#
...
USAGE() {
INFO "curl -SsL ${BASEURL}/Rage4/install-bird.sh | bash -s REGION ANYCASTIP1,ANYCASTIP2..."
exit 0
}
