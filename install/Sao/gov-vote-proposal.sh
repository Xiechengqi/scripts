...
export validatorAddress=$(curl -SsL https://gitee.com/Xiechengqi/scripts/raw/master/install/Cosmos/get-local-validator-address.sh | bash -s saod ${SAO_HOME} | awk -F ': ' '{print $NF}')
