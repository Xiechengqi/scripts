...
echo "${osInfo}" | grep -E 'ubuntu20' &>/dev/null && downloadUrl="https://github.com/ArweaveTeam/arweave/releases/download/N.${version}/arweave-${version}.ubuntu20-x86_64.tar.gz" || downloadUrl="https://github.com/ArweaveTeam/arweave/releases/download/N.${version}/arweave-${version}.ubuntu18-x86_64.tar.gz"
