...
#
# 2025/04/20
# fork from https://raw.githubusercontent.com/helm/helm/master/scripts/get-helm-3
# usage: curl -SsL https://gitee.com/Xiechengqi/scripts/raw/master/install/Helm/install.sh | sudo bash
#
