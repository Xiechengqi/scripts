...
| [vet-node](https://github.com/Xiechengqi/scripts/edit/master/install/Vet/vet-node/install.sh) | `curl -SsL https://gitee.com/Xiechengqi/scripts/raw/master/install/Vet/vet-node/install.sh \| bash -s [mainnet\|testnet]` |
